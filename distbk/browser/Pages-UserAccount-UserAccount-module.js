...
/* harmony import */ var _shared_utils_error_handling__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../shared/utils/error-handling */ "./src/app/shared/utils/error-handling.ts");
...
var OrderHistoryComponent = /** @class */ (function () {
    function OrderHistoryComponent(embryoService, proyectoService, http, errorHandling) {
        this.embryoService = embryoService;
        this.proyectoService = proyectoService;
        this.http = http;
        this.errorHandling = errorHandling;
        this.displayedColumns = ['imagen', 'nombre', 'especie', 'cantidad', 'precio', 'action'];
        this.dataSource = [];
        this.proyectos = [];
    }
    ...
    OrderHistoryComponent.prototype.getTotalPrice = function () {
        var total = 0;
    ...
    OrderHistoryComponent.prototype.loadProyectos = function () {
        var _this = this;
        ...
        if (usuario.Autenticado) {
            this.proyectoService.getProyectosPorMiembro(usuario.MiembroId)
                ...
                _this.dataSource = _this.proyectos;
    ...
    OrderHistoryComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_Services_Embryo_service__WEBPACK_IMPORTED_MODULE_1__["EmbryoService"], _Services_proyecto_service__WEBPACK_IMPORTED_MODULE_5__["ProyectoService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], _shared_utils_error_handling__WEBPACK_IMPORTED_MODULE_4__["ErrorHandling"]])
